 ...
 */
function login() {
    return location.href = "http://localhost:8184/page/login";
}
function regist() {
    return location.href = "http://localhost:8184/page/register";
}
...
function search(a) {
    var b = "http://localhost:8181/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
