...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="狗蛋"/>
		...
		<input type="hidden" name="orderShipping.receiverDistrict" value="朝阳区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="朝外大街  xxxxxxxxx"/>
</form>
